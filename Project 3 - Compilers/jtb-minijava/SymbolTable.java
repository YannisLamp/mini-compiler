...
public class SymbolTable {
    ...
    */
    ...
    public Map<String, ClassInfo> getClassMap() { return classMap; }

    public MethodInfo getCurrMethod() { return currMethod; }
    ...
    // Actual public method called to store offsets
            ...
            if (iter != 0) {
                ...
                if (varIdSet != null) {
                    for (String varId : varIdSet) {
                        tempClass.getVarOffsets().put(varId, currOffset);
                ...
                // Save field size
                classMap.get(classId).setFieldSize(currOffset);
                // Save method offsets
                ...
                if (methIdSet != null) {
                    ...
                    if (tempClass.getParentId() != null) {
                        ...
                        // Save parent method offsets
                        for (String methId : parMethSet) {
                            if (!methId.equals("main")) {
                                tempClass.getMethodOffsets().put(methId, currOffset);
                                currOffset += 8;
                            }
                        }
                    ...
                    // Else only save method offsets for this class
                    else {
                        for (String methId : methIdSet) {
                            tempClass.getMethodOffsets().put(methId, currOffset);
                            currOffset += 8;
    ...
    // Method
    public int calcParentVarOffset(String classId) {
        if (classMap.containsKey(classId)) {
            ClassInfo tempClass = classMap.get(classId);
            int currOffset = 0;
            if (tempClass.getParentId() != null)
    ...
    public Set<String> getParentMethods(String parClassId) {
...
class ClassInfo {
    ...
    public void setFieldSize(int inputSize) { fieldSize = inputSize; }
